...
QString DataCodeStr::toString_name(const DataCode &dtc) {
    ...
    case GRB_PRESSURE_MSL:
        return tr("Pressure") + " " + tr("MSL");
    case GRB_GEOPOT_HGT:
        return tr("Geopotential");
    case GRB_TEMP:
        return tr("Temperature");
    case GRB_TEMP_POT:
        return tr("Potential temperature");
    case GRB_TMAX:
        return tr("Temperature max");
    case GRB_TMIN:
        return tr("Temperature min");
    case GRB_DEWPOINT:
        return tr("Dew point");
    case GRB_CUR_VX:
        return tr("Current (Vx)");
    case GRB_CUR_VY:
        return tr("Current (Vy)");
    case GRB_WIND_VX:
        return tr("Wind (Vx)");
    case GRB_WIND_VY:
        return tr("Wind (Vy)");
    ...
    case GRB_WIND_SPEED:
        return tr("Wind (speed)");
    case GRB_HUMID_SPEC:
        return tr("Specific humidity");
    case GRB_HUMID_REL:
        return tr("Relative humidity");
    case GRB_PRECIP_RATE:
        return tr("Precipitation rate");
    case GRB_PRECIP_TOT:
        return tr("Total precipitation");
    case GRB_SNOW_DEPTH:
        return tr("Snow (depth)");
    case GRB_CLOUD_TOT:
        return tr("Cloud cover");
    case GRB_CLOUD_LOW:
        return tr("Cloud cover (low)");
    case GRB_CLOUD_MID:
        return tr("Cloud cover (middle)");
    case GRB_CLOUD_HIG:
        return tr("Cloud cover (high)");
    case GRB_FRZRAIN_CATEG:
        return tr("Frozen rain possible");
    case GRB_SNOW_CATEG:
        return tr("Snowfall possible");
    case GRB_CAPE:
        return tr("CAPE");
    case GRB_CIN:
        return tr("CIN");
    ...
    case GRB_PRV_WIND_JET:
        return tr("Wind (jet stream)");
    case GRB_PRV_DIFF_TEMPDEW:
        return tr("Gap temperature-dew point");
    case GRB_PRV_THETA_E:
        return tr("Theta-e");
    case GRB_WIND_GUST:
        return tr("Wind gust");
    case GRB_WIND_GUST_VX:
        return tr("Wind gust (Vx)");
    case GRB_WIND_GUST_VY:
        return tr("Wind gust (VY)");
    case GRB_PRV_CUR_DIR:
        return tr("Current direction");
    case GRB_PRV_CUR_XY2D:
        return tr("Current");

    case GRB_WAV_SIG_HT:
        return tr("Significant wave");
    case GRB_WAV_WND_DIR:
        return tr("Wind wave direction");
    case GRB_WAV_WND_HT:
        return tr("Wind wave height");
    case GRB_WAV_WND_PER:
        return tr("Wind wave period");
    case GRB_WAV_SWL_DIR:
        return tr("Swell wave direction");
    case GRB_WAV_SWL_HT:
        return tr("Swell wave height");
    case GRB_WAV_SWL_PER:
        return tr("Swell wave period");
    case GRB_WAV_PRIM_DIR:
        return tr("Primary wave direction");
    case GRB_WAV_PRIM_PER:
        return tr("Primary wave period");
    case GRB_WAV_SCDY_DIR:
        return tr("Secondary wave direction");
    case GRB_WAV_SCDY_PER:
        return tr("Secondary wave period");
    case GRB_WAV_MAX_DIR:
        return tr("Maximum wave direction");
    case GRB_WAV_MAX_HT:
        return tr("Maximum wave height");
    case GRB_WAV_MAX_PER:
        return tr("Maximum wave period");
    case GRB_WAV_WHITCAP_PROB:
        return tr("Whitecap probability");

    case GRB_PRV_WAV_SIG:
        return tr("Significant wave");
    case GRB_PRV_WAV_MAX:
        return tr("Maximum wave");
    case GRB_PRV_WAV_SWL:
        return tr("Swell");
    case GRB_PRV_WAV_WND:
        return tr("Wind wave");
    case GRB_PRV_WAV_PRIM:
        return tr("Primary wave");
    case GRB_PRV_WAV_SCDY:
        return tr("Secondary wave");
