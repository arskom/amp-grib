...
void DialogSelectMetar::make_metar_tree() {
    ...
    QSet<QString> allExpanded = QSet<QString>::fromList(Util::getSetting("metar_country_expanded", QStringList()).toStringList());
    QSet<QString> allSelected = QSet<QString>::fromList(Util::getSetting("metar_selected", QStringList()).toStringList());
