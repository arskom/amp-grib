...
void Terrain::paintEvent(QPaintEvent *) {
    ...
    if (!isResizing || !firstDrawingIsDone) {
        ...
        case DATATYPE_GRIB:
        case DATATYPE_MBLUE:
            drawer->draw_GSHHS_and_GriddedData(pnt, mustRedraw, isEarthMapValid, proj, griddedPlot, drawCartouche);
            break;
        case DATATYPE_IAC:
            drawer->draw_GSHHS_and_IAC(pnt, mustRedraw, isEarthMapValid, proj, iacPlot, drawCartouche);
            break;
        default:
        ...
        case DATATYPE_GRIB:
        case DATATYPE_MBLUE:
            drawer->draw_GSHHS_and_GriddedData(pnt, false, true, proj, griddedPlot);
            break;
        case DATATYPE_IAC:
            drawer->draw_GSHHS_and_IAC(pnt, false, true, proj, iacPlot);
            break;
        default:
            drawer->draw_GSHHS(pnt, mustRedraw, isEarthMapValid, proj);
        }
