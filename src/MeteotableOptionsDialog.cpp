...
void DialogMeteotableOptions::addData(QString title, uchar grbtype, uchar leveltype, uint level,
    ...
    MeteotableOptionItem *item = new MeteotableOptionItem(title, DataCode(grbtype, leveltype, level),
...
void DialogMeteotableOptions::createDataLists() {
    ...
    int type;
    type = GRB_WAV_SIG_HT;
    addData(tr("Waves") + ": " + DataCodeStr::toString(type), type, LV_GND_SURF, 0, defaultvis, defaultpos++);
    type = GRB_PRV_WAV_MAX;
    addData(tr("Waves") + ": " + DataCodeStr::toString(type), type, LV_GND_SURF, 0, defaultvis, defaultpos++);
    type = GRB_PRV_WAV_WND;
    addData(tr("Waves") + ": " + DataCodeStr::toString(type), type, LV_GND_SURF, 0, defaultvis, defaultpos++);
    type = GRB_PRV_WAV_SWL;
    addData(tr("Waves") + ": " + DataCodeStr::toString(type), type, LV_GND_SURF, 0, defaultvis, defaultpos++);
    type = GRB_PRV_WAV_PRIM;
    addData(tr("Waves") + ": " + DataCodeStr::toString(type), type, LV_GND_SURF, 0, defaultvis, defaultpos++);
    type = GRB_PRV_WAV_SCDY;
    addData(tr("Waves") + ": " + DataCodeStr::toString(type), type, LV_GND_SURF, 0, defaultvis, defaultpos++);
    type = GRB_WAV_WHITCAP_PROB;
    addData(tr("Waves") + ": " + DataCodeStr::toString(type), type, LV_GND_SURF, 0, defaultvis, defaultpos++);
    //----------------------------------
