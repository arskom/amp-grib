...
public:
    ...
    Projection_ZYGRIB *clone() { return new Projection_ZYGRIB(*this); }
...
public:
    ...
    Projection_libproj *clone() { return new Projection_libproj(*this); }
...
public:
    ...
    Projection_CENTRAL_CYL *clone() { return new Projection_CENTRAL_CYL(*this); }
...
public:
    ...
    Projection_MILLER *clone() { return new Projection_MILLER(*this); }
};
