        ...
        if (file != NULL) {
            ...
            while (ok) {
                ...
                if (ok) {
                    ...
                    case 1:
                        lsPoly_level1[quality]->push_back(poly);
                        break;
                    case 2:
                        lsPoly_level2[quality]->push_back(poly);
                        break;
                    case 3:
                        lsPoly_level3[quality]->push_back(poly);
                        break;
                    case 4:
                        lsPoly_level4[quality]->push_back(poly);
                        break;
                    }
                }
            }
...
std::vector<GshhsPolygon *> &GshhsReader::getList_level(int level) {
    ...
    case 2:
        return *lsPoly_level2[quality];
    case 3:
        return *lsPoly_level3[quality];
    case 4:
        return *lsPoly_level4[quality];
    default:
        return *lsPoly_level1[quality];
    }
}
