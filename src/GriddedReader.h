...
public:
    ...
    virtual bool getZoneExtension(double *x0, double *y0, double *x1, double *y1) = 0;
    ...
    virtual time_t getFirstDate() { return setAllDates.size() > 0 ? *setAllDates.begin() : 0; }
    ...
    std::set<DataCenterModel> getAllDataCenterModel() { return setAllDataCenterModel; }
